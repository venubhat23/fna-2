#!/usr/bin/env ruby
# Setup Insurance Policies for Customer - FINAL VERSION
# Usage: RAILS_ENV=development bundle exec rails runner setup_customer_insurance_final.rb
...
life_policy_2 = LifeInsurance.create!(
  ...
  policy_number: "KOTAK#{Date.current.strftime('%Y')}#{customer.id.to_s.rjust(3, '0')}01",
